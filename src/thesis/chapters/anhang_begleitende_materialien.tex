...
Zur Veranschaulichung wird hier exemplarisch die Reproduktion des Closed-World-Laufs \texttt{exp-baseline-80} skizziert, dessen Ergebnis in Tabelle~\ref{tab:eval_results} dokumentiert ist.
...
\begin{enumerate}
    ...
    \item Resultate ablesen: \texttt{cat wflib/logs/ExpBaseline80/DF/result.json} liefert die in Tabelle~\ref{tab:eval_results} verglichenen Kennzahlen.
\end{enumerate}
