...
Statt eines Cell-Traces wird in unserer Simulation am Monitor eine \gls{pcap} Datei mitgeschnitten und anschliessend in Richtungssequenzen umgewandelt.
...
Ausserdem bildet das \gls{pcap} ein realistisches Angriffsszenario von einem passiven Beobachter. Angreifer haben normalerweise auch keinen Zugriff auf die Tor Cell-Traces ~\cite{jansen2023data}.
