...
Im Folgenden bezeichnet Klasse die einer Webseite zugeordnete Zielkategorie der Klassifikation, das heisst eine Wikipedia-Seite entspricht einer Klasse.
...
Der Port dient dabei als ganzzahliges, eindeutiges Klassen-Label.

Im Konvertierungsschritt erfolgt die Zuordnung von Paketen zu Besuchen über das Zeitfenster aus dem Schedule (Startzeit zuzüglich Besuchsintervall).
Der für diesen Besuch hinterlegte Port liefert das Klassen-Label.
Da jeder Monitor zu einem Zeitpunkt nur eine URL und damit nur einen Zielport abruft, enthält jedes Besuchsfenster Verkehr aus genau einer Klasse.
Eine Klassenmarkierung im Tor-Datenstrom selbst, wie sie Jansen und Wails über eine gepatchte Tor-Version umsetzen~\cite{jansen2023data}, ist damit nicht notwendig.
