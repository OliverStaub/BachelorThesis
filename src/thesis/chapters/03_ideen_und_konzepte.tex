...
Diese Zuordnung muss bei der Simulationsplanung festgehalten werden, weil sie aus dem Monitor-Pcap allein nicht rekonstruierbar ist.
Das Monitor-Pcap zeichnet ausschliesslich den verschlüsselten Verkehr zum Tor-Guard auf Port~9001 auf, der eigentliche Zielport zum Wikipedia-Spiegel liegt innerhalb der Tor-Zellen und ist erst am Exit-Relay wieder im Klartext lesbar.
Damit entspricht der Aufbau dem realistischen Angreifermodell: dem passiven Beobachter zwischen Monitor und Guard sind weder Ziel-IP noch Zielport zugänglich, und genau diese Information liefert die Plandatei dem Experimentator als Ground Truth.
