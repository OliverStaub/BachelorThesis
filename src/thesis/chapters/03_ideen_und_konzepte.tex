...
Damit arbeiten wir auf der TCP Ebene und erfahren einen Detailverlust.  Die zellgenaue Auflösung der Cell-Traces wird nicht erreicht, was zu einem Informationsverlust führt gegenüber den Cell-Traces.

Zugleich bildet dieses \gls{pcap}-Verfahren ein realistisches Angriffsszenario eines passiven Beobachter ab, dem ebenfalls keine internen Tor-Cell-Traces zur Verfügung stehen~\cite{jansen2023data}.
