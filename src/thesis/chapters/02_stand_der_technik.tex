...
Der Tor Browser greift via SOCKS5 auf den Tor Deamon zu.
Der Deamon leitet den Internetverkehr dann über das Tor Netzwerk.
Dazu versendet er Tor Cells via TCP.
Der Tor Browser greift auf den eigentlichen Tor Daemon zu und leitet den gesamten Internetverkehr des Browsers über einen SOCKS5 Proxy in das Tor Netzwerk weiter.
...
groups all first-party streams onto the same circuit. But if you have multiple tabs or are loading different pages, those go on separate circuits. 
