...
Die virtuelle Maschine wurde von HSLU Lab Services im Rahmen der Bachelorarbeit bereitgestellt.
...
Beim ersten Login auf der VM wurde das initiale Passwort des Administratorkontos in ein neues, nicht weitergegebenes Passwort geändert.
...
Beim Pull der Resultate auf die lokale Arbeitsstation wird pro Experiment dasselbe Unterverzeichnisschema gespiegelt, sodass lokal und auf der VM dieselbe Struktur vorliegt.
...
Die in Abschnitt~\ref{sec:eval_performance} gezeigte Abbildung~\ref{fig:eval_perfmon_comparison} fasst den Ressourcenverlauf der drei \gls{tamaraw}-Läufe grafisch zusammen.
