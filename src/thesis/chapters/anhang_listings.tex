...
Die von \texttt{generate-urls.py} erzeugte Datei \texttt{urls.txt} legt fest, welche Wikipedia-Seiten den Monitor-Hosts zugewiesen werden (vgl.\ Abschnitt~\ref{sec:realisierung_urls}).
