...
\def\dx{32mm}
% Horizontaler Versatz der Zwiebel-Schichten (positiv = nach rechts)
\def\ox{6mm}
...
\fill[red!30]    (0.5*\dx+\ox-4mm, 13mm) rectangle ++(8mm, 6mm);
\draw            (0.5*\dx+\ox-4mm, 13mm) rectangle ++(8mm, 6mm);
\fill[orange!50] (0.5*\dx+\ox-3mm, 14mm) rectangle ++(6mm, 4mm);
\draw            (0.5*\dx+\ox-3mm, 14mm) rectangle ++(6mm, 4mm);
\fill[yellow!70] (0.5*\dx+\ox-2mm, 15mm) rectangle ++(4mm, 2mm);
\draw            (0.5*\dx+\ox-2mm, 15mm) rectangle ++(4mm, 2mm);

% Hop 2 (Guard -> Middle): two layers
\fill[orange!50] (1.5*\dx+\ox-3mm, 14mm) rectangle ++(6mm, 4mm);
\draw            (1.5*\dx+\ox-3mm, 14mm) rectangle ++(6mm, 4mm);
\fill[yellow!70] (1.5*\dx+\ox-2mm, 15mm) rectangle ++(4mm, 2mm);
\draw            (1.5*\dx+\ox-2mm, 15mm) rectangle ++(4mm, 2mm);

% Hop 3 (Middle -> Exit): one layer
\fill[yellow!70] (2.5*\dx+\ox-2mm, 15mm) rectangle ++(4mm, 2mm);
\draw            (2.5*\dx+\ox-2mm, 15mm) rectangle ++(4mm, 2mm);
