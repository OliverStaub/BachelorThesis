...
\node[rhdrbox,  minimum width=14mm] (r1) at (7mm,   -20mm) {RelayCmd\\\scriptsize 1 B};
\node[rhdrbox,  minimum width=14mm] (r2) at (21mm,  -20mm) {Recog.\\\scriptsize 2 B};
\node[rhdrbox,  minimum width=16mm] (r3) at (36mm,  -20mm) {StreamID\\\scriptsize 2 B};
\node[rhdrbox,  minimum width=14mm] (r4) at (51mm,  -20mm) {Digest\\\scriptsize 4 B};
\node[rhdrbox,  minimum width=14mm] (r5) at (65mm,  -20mm) {Length\\\scriptsize 2 B};
\node[rdatabox, minimum width=50mm] (r6) at (97mm,  -20mm) {Daten\\\scriptsize 498 B};
