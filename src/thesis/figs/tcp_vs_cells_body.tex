...
% ----------------------------------------------------------
\node[lbl] at (-2mm, 6mm) {TCP-Segmente};
\node[lbl] at (-2mm, 2mm) {(variable Länge)};
...
\node[seg, minimum width=36mm] (s3) at (80mm, 4mm) {Segment 3};https://www.overleaf.com/user/settings#references
